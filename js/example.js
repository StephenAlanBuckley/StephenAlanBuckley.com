(function() {
  ...
  var Body = window.Body = function(physics,details) {
    ...
    this.definition.damping = details.damping !== null? details.damping : 1;
  ...
  function init() {
    ...
    window.bdy = new Body(physics, { shape: "circle", restitution:.5, x:40, y: 6});
    new Body(physics, { shape: "circle", x:35, y: 6});
