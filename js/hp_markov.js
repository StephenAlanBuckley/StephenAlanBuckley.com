$(function() {
  ...
  madnessButton.click(function(e) {
    ...
    var site_start = "http://stephenalanbuckley.com";

    e.preventDefault();
    var total_text ='';
    var wpdr_request = $.ajax({
      url: site_start + "/text_files/harry_potter/wpdr_script.txt",
      type: "get"
    }).done(function (data){
    ...
    var wpdr_request = $.ajax({
      url: site_start + "/text_files/harry_potter/hpmor_script.txt",
      type: "get"
    }).done(function (data){
    ...
    var hpass_request = $.ajax({
      url: site_start + "/text_files/harry_potter/hpass_script.txt",
      type: "get"
    }).done(function (data){
